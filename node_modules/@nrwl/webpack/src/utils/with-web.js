...
const hash_format_1 = require("@nrwl/webpack/src/utils/hash-format");
const postcss_cli_resources_1 = require("@nrwl/webpack/src/utils/webpack/plugins/postcss-cli-resources");
const normalize_entry_1 = require("@nrwl/webpack/src/utils/webpack/normalize-entry");
...
function withWeb(pluginOptions = {}) {
    return function configure(config, { options: executorOptions, context }) {
        ...
        config.resolve.mainFields = [
            'browser',
            ...((_c = config.resolve.mainFields) !== null && _c !== void 0 ? _c : []),
        ];
        config.module = Object.assign(Object.assign({}, config.module), { rules: [
                ...((_d = config.module.rules) !== null && _d !== void 0 ? _d : []),
                {
...
//# sourceMappingURL=with-web.js.map