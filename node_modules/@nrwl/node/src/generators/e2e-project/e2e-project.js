...
function e2eProjectGenerator(host, _options) {
    ...
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        if (options.projectType === 'server') {
            (0, devkit_1.generateFiles)(host, path.join(__dirname, 'files/server'), options.e2eProjectRoot, Object.assign(Object.assign(Object.assign({}, options), (0, devkit_1.names)(options.rootProject ? 'server' : options.project)), { offsetFromRoot: (0, devkit_1.offsetFromRoot)(options.e2eProjectRoot), tmpl: '' }));
        }
            ...
            (0, devkit_1.generateFiles)(host, path.join(__dirname, 'files/cli'), options.e2eProjectRoot, Object.assign(Object.assign(Object.assign({}, options), (0, devkit_1.names)(options.rootProject ? 'server' : options.project)), { mainFile, offsetFromRoot: (0, devkit_1.offsetFromRoot)(options.e2eProjectRoot), tmpl: '' }));
        }
