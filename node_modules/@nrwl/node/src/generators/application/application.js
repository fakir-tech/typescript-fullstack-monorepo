...
function updateTsConfigOptions(tree, options) {
    (0, devkit_1.updateJson)(tree, `${options.appProjectRoot}/tsconfig.json`, (json) => {
        if (options.rootProject) {
            return Object.assign(Object.assign({ compilerOptions: Object.assign(Object.assign(Object.assign({}, js_2.tsConfigBaseOptions), json.compilerOptions), { esModuleInterop: true }) }, json), { extends: undefined, exclude: ['node_modules', 'tmp'] });
        }
        else {
