...
class ApolloBaseDriver extends graphql_1.AbstractGraphQLDriver {
    ...
    stop() {
        var _a;
        return (_a = this.apolloServer) === null || _a === void 0 ? void 0 : _a.stop();
    }
    ...
    wrapFormatErrorFn(options) {
        ...
        if (options.formatError) {
            ...
            options.formatError = (formattedError, err) => {
                err = transformHttpErrorFn(formattedError, err);
    ...
    createTransformHttpErrorFn() {
        return (formattedError, originalError) => {
            ...
            const isHttpException = ((_a = exceptionRef === null || exceptionRef === void 0 ? void 0 : exceptionRef.response) === null || _a === void 0 ? void 0 : _a.statusCode) && (exceptionRef === null || exceptionRef === void 0 ? void 0 : exceptionRef.status);
            if (!isHttpException) {
            ...
            if (httpStatus in apolloPredefinedExceptions) {
                error = new graphql_2.GraphQLError(exceptionRef === null || exceptionRef === void 0 ? void 0 : exceptionRef.message, {
            ...
            if (exceptionRef === null || exceptionRef === void 0 ? void 0 : exceptionRef.response) {
        ...
        if (!targetOptions.context) {
            targetOptions.context = async (contextOrRequest) => {
                ...
                return {
                    ...
                    req: (_a = contextOrRequest.req) !== null && _a !== void 0 ? _a : contextOrRequest,
                };
            };
        }
            ...
            targetOptions.context = async (...args) => {
                ...
                return this.assignReqProperty(ctx, (_a = contextOrRequest.req) !== null && _a !== void 0 ? _a : contextOrRequest);
            };
        }
        else {
            targetOptions.context = async (contextOrRequest) => {
                var _a;
                return this.assignReqProperty(originalOptions.context, (_a = contextOrRequest.req) !== null && _a !== void 0 ? _a : contextOrRequest);
            };
        }
    }
